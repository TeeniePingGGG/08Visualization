...
'''
데이터 프레임에서 특정 요소 하나를 선택할때는 Java의 배열과 유사하게
...
print(f"{'0,2 출력':-^30}")
# 문자령 인덱스를 지정하더라도 숫자형 인덱스로 접근 할 수 있다.
b = df.iloc[0,2] # 유비의 수학 점수 접근
print(b)
